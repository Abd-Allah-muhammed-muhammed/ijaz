...
return [
     ...
     *
     * Dedicated queue so image conversion work does not starve default jobs
     * (notifications, etc.). Workers must listen to `media-conversions`
     * (appended on the default Supervisor/Horizon supervisor — see README).
     */
