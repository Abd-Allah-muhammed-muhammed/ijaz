...
export {
  ...
  isImageFile,
  isPdfFile,
} from '@/shared/uploads/lib/compress-image';

export {
  useEagerFileUpload,
  type EagerUploadEntry,
  type EagerUploadFn,
  type EagerUploadFnArgs,
  type EagerUploadStatus,
  type EagerUploadSuccess,
  type UseEagerFileUploadOptions,
  type UseEagerFileUploadResult,
} from '@/shared/uploads/hooks/use-eager-file-upload';

export {
  prepareLocalImage,
  validateImageMime,
  validateImageSize,
} from '@/shared/uploads/hooks/use-local-image-prepare';
