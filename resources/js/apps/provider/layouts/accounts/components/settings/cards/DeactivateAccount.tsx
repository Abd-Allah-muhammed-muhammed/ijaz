...
export type DeactivateAccountProps = {
  /**
   * When true, omit the Metronic card/collapse chrome so a parent
   * (e.g. Profile Danger Zone) can supply the outer shell.
   */
  embedded?: boolean;
};

const DeactivateAccount: FC<DeactivateAccountProps> = ({
  embedded = false,
}) => {
  ...
  const formBody = (
    <form id="kt_account_deactivate_form" className="form" onSubmit={submitDeactivation}>
      <div className={embedded ? 'pb-4' : 'card-body border-top p-9'}>
          ...
          <div className="d-flex flex-stack flex-grow-1">
            <div className="fw-bold">
              <h4 className="text-gray-800 fw-bolder">
                {t('you_are_deactivating_your_account')}
              </h4>
