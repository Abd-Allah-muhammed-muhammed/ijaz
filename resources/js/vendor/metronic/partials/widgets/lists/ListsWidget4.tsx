...
import {Dropdown1} from '@/vendor/metronic/partials'
    ...
    <div className='card card-xl-stretch mb-xl-8'>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold text-gray-900'>Orders</span>
          <span className='text-muted mt-1 fw-semibold fs-7'>Latest tech Orders</span>
        </h3>
      ...
      <div className='card-body pt-5'>
        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='symbol symbol-50px me-5'>
            <span className='symbol-label'>
              <img
                src={url('media/svg/brand-logos/plurk.svg')}
        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='symbol symbol-50px me-5'>
            <span className='symbol-label'>
              <img
                src={url('media/svg/brand-logos/telegram.svg')}
                className='h-50 align-self-center'
                alt=''
              />
            </span>
        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='symbol symbol-50px me-5'>
            <span className='symbol-label'>
              <img
                src={url('media/svg/brand-logos/vimeo.svg')}
                className='h-50 align-self-center'
                alt=''
              />
            </span>
        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='symbol symbol-50px me-5'>
            <span className='symbol-label'>
              <img
                src={url('media/svg/brand-logos/bebo.svg')}
                className='h-50 align-self-center'
                alt=''
              />
            </span>
        ...
        {items > 4 && (
          <div className='d-flex align-items-sm-center mb-7'>
            ...
            <div className='symbol symbol-50px me-5'>
              <span className='symbol-label'>
                <img
                  src={url('media/svg/brand-logos/kickstarter.svg')}
                  className='h-50 align-self-center'
                  alt=''
                />
              </span>
        ...
        {items > 5 && (
          <div className='d-flex align-items-sm-center'>
            ...
            <div className='symbol symbol-50px me-5'>
              <span className='symbol-label'>
                <img
                  src={url('media/svg/brand-logos/fox-hub.svg')}
                  className='h-50 align-self-center'
                  alt=''
                />
              </span>
