...
| app/Http/Controllers/Api/V1/GuaranteeRequestController.php | Status transition logic is embedded in the controller. | High | Move guarantee state transitions to a dedicated service or action class. |
