...
class OrderService
{
     ...
     */
    public function listRecommendedForProvider(Provider $provider, array $filters, int $perPage): LengthAwarePaginator
    {
        return $this->listRecommendedOrders->handle($provider, $filters, $perPage);
    }
