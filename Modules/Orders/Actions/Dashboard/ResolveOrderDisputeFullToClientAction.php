...
class ResolveOrderDisputeFullToClientAction
{
    ...
    public function handle(
        ...
        return DB::transaction(function () use ($order, $admin, $notes) {
            ...
            $this->logStatusHistory->handle(
                ...
                $admin,
                $fromStatus,
                OrderStatusEnum::CancelledViaDispute->value,
