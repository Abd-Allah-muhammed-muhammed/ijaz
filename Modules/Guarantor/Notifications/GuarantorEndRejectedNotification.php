...
/**
 * Counterparty rejected the requester's end request.
 */
class GuarantorEndRejectedNotification extends DomainNotification implements ShouldBroadcastNow, ShouldDispatchAfterCommit
{
    ...
    {
        return 'guarantor_end_rejected_title';
    }

    protected function bodyKey(): string
    {
        return 'guarantor_end_rejected_body';
    }
