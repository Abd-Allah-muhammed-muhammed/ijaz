...
class GuarantorApprovedNotification extends Notification implements ShouldBroadcastNow, ShouldDispatchAfterCommit, ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'title_translated_key' => 'guarantor_approved',
            'body_translated_key' => 'guarantor_has_been_approved',
    ...
    public function toBroadcast(object $notifiable): BroadcastMessage
    {
        return (new BroadcastMessage([
            'title' => trans('guarantor_approved', locale: $notifiable->language),
            'body' => trans('guarantor_has_been_approved', locale: $notifiable->language),
            'guarantor_request_id' => $this->guarantorRequest->id,
        ]))->onConnection('sync');
    }
