...
class GuarantorRejectedNotification extends Notification implements ShouldBroadcastNow, ShouldDispatchAfterCommit, ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'title_translated_key' => 'guarantor_rejected',
            'body_translated_key' => 'guarantor_has_been_rejected',
    ...
    public function toBroadcast(object $notifiable): BroadcastMessage
    {
        return (new BroadcastMessage([
            'title' => trans('guarantor_rejected', locale: $notifiable->language),
            'body' => trans('guarantor_has_been_rejected', locale: $notifiable->language),
            'guarantor_request_id' => $this->guarantorRequest->id,
        ]))->onConnection('sync');
    }
