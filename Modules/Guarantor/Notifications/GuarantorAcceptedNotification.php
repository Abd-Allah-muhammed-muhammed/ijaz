...
class GuarantorAcceptedNotification extends DomainNotification implements ShouldBroadcastNow, ShouldDispatchAfterCommit
{
    ...
    {
        return 'guarantor_accepted';
    }

    protected function bodyKey(): string
    {
        return 'guarantor_has_been_accepted';
    }
