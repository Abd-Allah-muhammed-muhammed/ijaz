...
class GuarantorAdminApprovedNotification extends DomainNotification implements ShouldBroadcastNow, ShouldDispatchAfterCommit
{
    public function __construct(public GuarantorRequest $guarantorRequest) {}

    protected function titleKey(): string
    {
        return 'guarantor_admin_approved';
    }

    protected function bodyKey(): string
    {
        return 'guarantor_has_been_admin_approved';
    }
