...
class OpportunityAdminApprovedNotification extends DomainNotification implements ShouldBroadcastNow, ShouldDispatchAfterCommit
{
    public function __construct(public Opportunity $opportunity) {}

    protected function titleKey(): string
    {
        return 'opportunity_admin_approved';
    }

    protected function bodyKey(): string
    {
        return 'opportunity_has_been_admin_approved';
    }
    ...
    {
        return 'opportunity admin approved';
    }
}
