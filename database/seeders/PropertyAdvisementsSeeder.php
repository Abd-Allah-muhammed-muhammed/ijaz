...
class PropertyAdvisementsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $categoryIds = PropertiyCategory::query()->pluck('id')->toArray();
        ...
        if (empty($cityIds) || empty($regionIds) || empty($propertyTypeIds) || empty($categoryIds)) {
            throw new \Exception('Missing required data. Please ensure cities, regions, property_types, and propertiy_categories exist before running this seeder.');
        }
