...
return [
    'dispute_resolution' => [
        'full_user' => 'مکمل کلائنٹ',
        'full_provider' => 'مکمل فراہم کنندہ',
        'escalate' => 'بڑھانا',
        'percentage_split' => 'فیصد تقسیم',
    ],
    'dispute_outcome_full_user' => 'کلائنٹ کے حق میں حل',
    'dispute_outcome_full_provider' => 'فراہم کنندہ کے حق میں حل',
