...
return [
    'dispute_resolution' => [
        'full_user' => 'Full to client',
        'full_provider' => 'Full to provider',
        'escalate' => 'Escalate',
        'percentage_split' => 'Percentage split',
    ],
    'dispute_outcome_full_user' => 'Resolved fully in favor of the client',
    'dispute_outcome_full_provider' => 'Resolved fully in favor of the provider',
