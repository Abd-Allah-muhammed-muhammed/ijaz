...
final readonly class StoreProviderDTO
{
    /**
    ...
    /**
     * @param  array{name: string, provider_type_id: int|string, region_id: int|string, city_id: int|string, address: string, phone: string, email: string, iban: string, about: string, password: string, categories: list<array{id: int|string, skills?: list<int|string>|null}>}  $validated
     * @param  array<string, UploadedFile>  $mediaFiles
     */
