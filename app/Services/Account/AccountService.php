...
use App\Actions\Account\GetUnreadNotificationsCountAction;
...
class AccountService
{
    public function __construct(
        ...
        private readonly GetUnreadNotificationsCountAction $getUnreadNotificationsCountAction,
    ...
    {
        return $this->getUnreadNotificationsCountAction->handle($user);
    }
